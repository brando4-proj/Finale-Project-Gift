const Element = document.getElementById("happy");
        ...
        const audiolyrics = [
            ...
            {time: 9, text: "Magready ka po.", src: "none"},
            {time: 15, text: "Ready? 😁", src: "none"},
            {time: 17, text: "Sa hiling ko pa tapos na man.", src: "none"},
            ...
            {time: 1 * 60 + 48, text: "Lujille kim!", src: "lujille.jpg"},
            {time: 1 * 60 + 49, text: "Happy Birthday to you! 😁", src: "none"},
            {time: 1 * 60 + 52, text: "Lujille Kim", src: "lujille.jpg"},
            ...
            {time: 1 * 60 + 56, text: "Lujille Kim", src: "lujille.jpg"},
            {time: 1 * 60 + 59, text: "Happy Birthday to you! 😃", src: "none"},
            {time: 1 * 60 + 60, text: "Lujille Kim", src: "lujille.kim"},
            {time: 2 * 60, text: "Happy Birthday to you! 😁", src: "none"},
            {time: 2 * 60 + 1, text: "Lujille Kim", src: "lujille.jpg"},
            {time: 2 * 60 + 2, text: "Happy Birthday to you! 🥳", src: "none"},
            {time: 2 * 60 + 3, text: "Lujille Kim", src: "lujille.jpg"},
            ...
            {time: 2 * 60 + 10, text: "Lujille Kim", src: "lujille.jpg"},
        ...
        document.getElementById("Receive").onclick = () => {
          ...
          audioElement.src = "happyBirthday.mp3";
        ...
        function finale(){
            ...
            setTimeout(() =>{
               ...
               audio2.src = "dance_all_night.mp3";
               audio2.play();
               ...
               div.style.margin = "150px 20px 150px 20px";
